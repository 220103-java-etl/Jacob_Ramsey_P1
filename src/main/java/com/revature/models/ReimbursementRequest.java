...
public class ReimbursementRequest extends AbstractReimbursementRequest{
    public ReimbursementRequest(int id, EventType eventType, String gradeingFormat, String standIndocProof, User u, String eventDate, BigDecimal totalCost, Status status, Timeing timeing,String location) {

        super(id, eventType,gradeingFormat,standIndocProof,u,eventDate,totalCost,status,timeing,location);
